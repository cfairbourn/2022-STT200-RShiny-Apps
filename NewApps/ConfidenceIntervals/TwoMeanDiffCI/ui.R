...
###############################################
# Two Mean Difference Confidence Interval App #
###############################################
...
ui <- fluidPage(
  titlePanel("Difference of Two Mean Confidence Interval"),
  sidebarLayout(
    sidebarPanel(
      tabsetPanel(
        tabPanel(
        ...
        tabPanel(
          ...
          tags$div(
            ...
            tags$p("From here, select the level of confidence desired, and record the estimated Confidence Interval","
                   found underneath the checkboxes underneath the plot."),
            ...
            tags$p("To make the boundaries be visible as lines on the graph,",
                   "press the 'Show Boundary Lines' button"),
            tags$p("You can also press 'Show Observed Difference' to create a line visible at the mean of the distribution"),
            hr(),
        ...
        tabPanel(
          ...
          fluidRow(
            column(
              ...
              fluidRow(
                ...
                column(
                  ...
                  textOutput("results"),
                  tags$head(
                    tags$style("#results{font-size: 20px;}")
                  )
                )
              )
            ),
            column(
              ...
              # ),
              plotOutput("data_visuals", height = "350px")
            )
          )
        )
      )
